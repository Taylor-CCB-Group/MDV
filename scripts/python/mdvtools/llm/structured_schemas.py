...
class ScatterPlotConfig(BaseModel):
    ...
    color_by: Optional[Union[str, Dict[str, Any]]] = Field(None, description="Field or column configuration used to determine color mapping")
    ...
    radius: Optional[float] = Field(None, description="Radius of scatter plot points in pixels")
...
class DataSource(BaseModel):
    ...
    large_images: Optional[Dict[str, Any]] = Field(None, description="High-resolution images for detailed viewing")
