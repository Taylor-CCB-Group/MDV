...
#required for vscode to fin the autoapi files and allows linting/on the fly builds
...
latex_documents = [
    (master_doc, 'MDV.tex', 'MDV Documentation',
...
man_pages = [
    (master_doc, 'MDV', 'MDV Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MDV', 'MDV Documentation',
     author, 'MDV', 'One line description of project.',
     'Miscellaneous'),
]
