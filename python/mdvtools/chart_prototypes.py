...
stat_viv_proto = {
    ...
    "tooltip": {
        "show": True,
        "column": "gmax_Periostin-Neutrophil"
    },
    "background_filter": {
        "category": "48639",
        "column": "sampleID"
...
ChartKeys = Literal['selection', 'stats', 'stats_viv', 'feature', 'contribution_heatmap', 'viv', 'violin', 'multi_line']
