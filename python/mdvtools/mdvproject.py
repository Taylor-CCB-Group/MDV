...
class MDVProject:
    ...
    def add_datasource_polars(
        ...
        try:
            ...
            columns = get_column_info_polars(
                columns, dataframe, supplied_columns_only, num_rows
            )
            ...
            for col in columns:
                try:
                    ...
                    add_column_to_group_from_polars(
                        col, polars_series, gr, num_rows, self.skip_column_clean
                    )
                except Exception as e:
...
def add_column_to_group_from_polars(
    col_info, polars_series, h5_group, num_rows, skip_column_clean
):
