...
class TestRescanProjectPermissions(unittest.TestCase):
    ...
    def test_rescan_grants_every_admin_ownership(
        ...
        self.assertEqual(
            mock_add_user_project.call_args_list,
            [
                call(user_id=1, project_id=10, is_owner=True),
                call(user_id=1, project_id=11, is_owner=True),
                call(user_id=2, project_id=10, is_owner=True),
                call(user_id=2, project_id=11, is_owner=True),
            ],
        )
        mock_cache_user_projects.assert_called_once_with()
