...
def main(project_path, dataset_path, question_list_path, output_csv):
    ...
    for question in question_list:
        try:
            ...
            prompt_RAG = "testing CI fix - this change should be reverted" ### get_createproject_prompt_RAG_copy(project, dataset_path, datasource_names[0], response['output'], response['input'])
