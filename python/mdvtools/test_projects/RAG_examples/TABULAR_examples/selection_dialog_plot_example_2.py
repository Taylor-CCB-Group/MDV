...
def main():
    ...
    title="Example title",
    params = ["param1", "param2", "param3", "param5", "param6", "param7", "param8"] # The 'param' list can accept any number of arguments, where each argument can be of any type, including categorical or variable types.
    size = [1002, 450]
    position = [23, 34]
