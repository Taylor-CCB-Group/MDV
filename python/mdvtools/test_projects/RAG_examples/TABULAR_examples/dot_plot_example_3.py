...
def main():
    ...
    # DotPlot parameters
    title = "Example Title"
    params = ["param3", "param4", "param5", "param6"] # The 'params' list can accept any number of arguments, param1 should be a categorical variable and the rest of params should be numerical variables.
    size = [792, 672]
    position = [130, 10]
