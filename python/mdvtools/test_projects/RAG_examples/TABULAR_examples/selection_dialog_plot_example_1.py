...
def main():
    ...
    title="Example title",
    params = ["param1", "param2", "param3", "param4", "param5", "param8"] # The 'param' list can accept any number of arguments, where each argument can be of any type, including categorical or variable types.
    size = [550, 550]
    position = [9, 11]
