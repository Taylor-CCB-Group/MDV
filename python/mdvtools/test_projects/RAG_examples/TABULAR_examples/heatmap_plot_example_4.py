...
def main():
    ...
    params = ["param1", "param2", "param3", "param4", "param5", "param6", "param7"] # The 'params' list can accept any number of arguments, param1 should be a categorical variable and the rest of params should be numerical variables.
    size = [892, 772]
    position = [5, 15]
