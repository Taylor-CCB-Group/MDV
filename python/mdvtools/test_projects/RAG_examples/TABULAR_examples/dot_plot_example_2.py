...
def main():
    ...
    # DotPlot parameters
    title = "Example Title"
    params = ["param1", "param2", "param3", "param4", "param5", "param6"] # The 'params' list can accept any number of arguments, param1 should be a categorical variable and the rest of params should be numerical variables.
    size = [500, 500]
    position = [230, 10]
