...
def main():
    ...
    title = "Example title for a heatmap plot"
    params = ["param1", "param2", "param3"] # The 'params' list can accept any number of arguments, param1 should be a categorical variable and the rest of params should be numerical variables.
    size = [800, 500]
    position = [100, 100]
