...
def main():
    ...
    title="Example title",
    params = ["param1", "param2", "param3", "param4", "param5", "param6", "param7", "param8", "param9"] # The 'param' list can accept any number of arguments, where each argument can be of any type, including categorical or variable types.
    size = [850, 850]
    position = [20, 5]
