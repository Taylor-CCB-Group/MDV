...
def main():
    ...
    scatter_title = "Scatter Plot: Disease Duration vs Age"
    scatter_params = ["Disease_duration", "Age"]
    scatter_size = [792, 472]
    scatter_position = [820, 10]
    scatter_x_axis_settings = {'size': 30, 'label': "Disease Duration", 'textsize': 13, 'tickfont': 10}
