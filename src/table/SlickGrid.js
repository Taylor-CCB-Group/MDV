...
(function( $ ) {
  ...
  function SlickGrid(container, data, columns, options) {
    ...
    function getMaxSupportedCssHeight() {
      ...
      var div = $("<div style='display:none' />").appendTo(__doc__.body);
    ...
    function bindAncestorScrollEvents() {
      ...
      while ((elem = elem.parentNode) != __doc__.body && elem != null) {
    ...
    function createCssRules() {
      ...
      if ($style[0].styleSheet) { // IE
        ...
        $style[0].appendChild(__doc__.createTextNode(rules.join(" ")));
      }
    }
    ...
    function autosizeColumns(autosizeMode, isInit) {
      ...
      canvas = __doc__.createElement("canvas");
    ...
    function getColHeaderWidth(columnDef) {
      ...
      var headerColEl = __doc__.getElementById(headerColElId);
    ...
    function cleanUpAndRenderCells(range) {
      ...
      var x = __doc__.createElement("div");
    ...
    function renderRows(range) {
      ...
      var x = __doc__.createElement("div"),
        xRight = __doc__.createElement("div");
    ...
    */
    ...
    function handleClick(e) {
      if (!currentEditor) {
        ...
        if (e.target != __doc__.activeElement || $(e.target).hasClass("slick-cell")) {
          setFocus();
        }
      }
    ...
    function getCellFromEvent(e) {
      ...
      if (hasFrozenRows) {
        ...
        row = getCellFromPoint(e.clientX - c.left, e.clientY - c.top + rowOffset + $(__doc__).scrollTop()).row;
      }
    ...
    function clearTextSelection() {
      if (__doc__.selection && __doc__.selection.empty) {
        try {
          //IE fails here if selected element is not in dom
          __doc__.selection.empty();
        } catch (e) { }
    ...
    function absBox(elem) {
      ...
      while ((elem = elem.parentNode) != __doc__.body) {
        if (elem == null) break;
