...
import type { DataSource, GuiSpec, GuiSpecType } from "./charts";
...
export type ChartType<T extends BaseChart> = {
    ...
    extra_controls?: (dataStore: DataStore) => any[]; //not GuiSpec<GuiSpecType>[]; - AddChartDialog & SettingsDialog behave differently - would like to unify
