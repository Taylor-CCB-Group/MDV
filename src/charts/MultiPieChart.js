...
class MultiPieChart extends SVGChart {
    ...
    initialSetUp() {
        ...
        const cat = this.dataStore.columnIndex[p[3]].values.indexOf(
    ...
    drawChart(tTime = 1000) {
        ...
        pas.selectAll(".pie-outer")
            ...
            .attr("stroke", (d) =>
                d.data[3] === this.highlight ? "black" : "white",
            )
            .attr("d", this.arc)
            .on("click", (e, d) => {
            ...
            .on("mouseover pointermove", (e, d) => {
                ...
                this.showToolTip(
                    e,
                    `${c1}<br>${c2}<br>${d.data[2].toFixed(2)}<br>${p}%`,
                );
            })
            .on("mouseleave", () => {
                this.hideToolTip();
            ...
            .style("stroke-width", (d) =>
                d.data[3] === this.highlight ? "4px" : "2px",
            )
            .style("fill", (d, i) => {
                return c2[d.data[1]];
            });
