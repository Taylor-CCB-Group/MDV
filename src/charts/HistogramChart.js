...
class HistogramChart extends SVGChart {
    constructor(dataStore, div, config) {
        ...
        this.brush = brushX().on("end", (e) => {
            ...
            this.setRange(
                this.x_scale.invert(s[0] - offset),
                this.x_scale.invert(s[1] - offset),
            );
        });
        ...
        return settings.concat([
            {
                ...
                info: {
                    text: `Sometimes outliers can skew the histogram to one side.
