...
export const PopoverPicker = ({ color, onChange }: { color?: MyRgbColor, onChange?: (newColor: MyRgbColor) => void}) => {
    const [r, g, b] = color || [255, 255, 255];

    const backgroundColor = color ? `#${r.toString(16).padStart(2, "0")}${g.toString(16).padStart(2, "0")}${b.toString(16).padStart(2, "0")}` : "#000000";
